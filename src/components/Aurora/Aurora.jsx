...
// Pad / truncate caller's color stops to exactly 5 (shader array size).
function normalizeStops(stops) {
  if (!stops || stops.length === 0) return ['#5227FF', '#5227FF', '#5227FF', '#5227FF', '#5227FF'];
  const arr = stops.slice(0, 5);
  while (arr.length < 5) arr.push(stops[stops.length - 1]);
  return arr;
}
